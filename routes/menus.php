...
Menu::register('adminarea.sidebar', function (MenuGenerator $menu, Tag $tag) {
    $menu->findByTitleOrAdd(trans('cortex/foundation::common.taxonomy'), 10, 'fa fa-arrows', [], function (MenuItem $dropdown) use ($tag) {
...
Menu::register('adminarea.tags.tabs', function (MenuGenerator $menu, Tag $tag) {
    $menu->route(['adminarea.tags.create'], trans('cortex/tags::common.details'))->ifCan('create', $tag)->if(! $tag->exists);
